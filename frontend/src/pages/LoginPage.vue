<template>
  <div class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden transition-colors" style="background-color: var(--unmute-bg); color: var(--unmute-text-primary);">
    ...
    <div class="absolute -top-20 -left-20 w-96 h-96 rounded-full blur-[130px] pointer-events-none animate-pulse-glow" style="background: var(--unmute-primary); opacity: 0.15;"></div>
    <div class="absolute -bottom-20 -right-20 w-96 h-96 rounded-full blur-[130px] pointer-events-none animate-pulse-glow" style="background: var(--unmute-primary-light); opacity: 0.12; animation-delay: 2s;"></div>
