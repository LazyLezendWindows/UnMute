    ...
    >
      <div class="d-flex flex-column gap-3">
        <div class="d-flex align-items-center gap-3 p-3 rounded-3 surface-raised border" style="border-color: var(--unmute-glass-border) !important;">
          ...
          <div class="small">
            <div class="fw-bold" style="color: var(--unmute-text-primary);">Snapchat Registration</div>
            <div class="text-muted extra-small">Sign up using your Snapchat account</div>
          </div>
        </div>
    ...
    >
      <div class="d-flex flex-column gap-3">
        <div class="d-flex align-items-center gap-3 p-3 rounded-3 surface-raised border" style="border-color: var(--unmute-glass-border) !important;">
          ...
          <div class="small">
            <div class="fw-bold" style="color: var(--unmute-text-primary);">Instagram Registration</div>
            <div class="text-muted extra-small">Sign up using your Instagram account</div>
          </div>
        </div>
